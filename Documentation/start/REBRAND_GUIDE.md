...
- Replace the logo files located in `src/assets/images/logo/` with your new logo files.
...
- Modify the primary, secondary, and accent colors in `src/styles/index.css` files to align with your brand colors.
